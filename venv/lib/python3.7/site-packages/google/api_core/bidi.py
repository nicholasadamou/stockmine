...
class _RequestQueueGenerator(object):
    ...
    def _is_active(self):
        ...
        return bool(self.call is None or self.call.is_active())
...
class _Throttle(object):
    ...
    def __repr__(self):
        return f"{self.__class__.__name__}(access_limit={self._access_limit}, time_window={repr(self._time_window)})"
