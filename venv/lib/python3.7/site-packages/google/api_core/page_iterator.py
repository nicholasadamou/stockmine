...
class HTTPIterator(Iterator):
    ...
    def _verify_params(self):
        ...
        """
        if reserved_in_use := self._RESERVED_PARAMS.intersection(
            self.extra_params
        ):
    ...
    def _has_next_page(self):
        ...
        if self.max_results is not None and self.num_results >= self.max_results:
            return False
...
class GRPCIterator(Iterator):
    ...
    def _next_page(self):
        ...
        return Page(self, items, self.item_to_value)
